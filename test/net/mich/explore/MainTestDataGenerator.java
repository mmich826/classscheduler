...
public class MainTestDataGenerator {
	...
	public List<Student> generateTestData(SchedulerMain mn) {
		...
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "bb-2"; classLeader = "Mr M"; location = "Gym"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "bb-3"; classLeader = "Mr MM"; location = "Gym"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "bb-4"; classLeader = "Mr MM"; location = "Gym"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		
		act = new Activity(); actName = "fb-1"; classLeader = "Mr B"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "fb-2"; classLeader = "Mr B"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "fb-3"; classLeader = "Mr B"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "fb-4"; classLeader = "Mr B"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		
		act = new Activity(); actName = "soccer-1"; classLeader = "Mr A"; location = "field 3"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "soccer-2"; classLeader = "Mr A"; location = "field 3"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "soccer-3"; classLeader = "Mr A"; location = "field 3"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "soccer-4"; classLeader = "Mr A"; location = "field 3"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		
		act = new Activity(); actName = "flag-1"; classLeader = "Mr C"; location = "field 4"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "flag-2"; classLeader = "Mr C"; location = "field 4"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "flag-3"; classLeader = "Mr C"; location = "field 4"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "flag-4"; classLeader = "Mr C"; location = "field 4"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		
		act = new Activity(); actName = "rock-1"; classLeader = "Mr DD"; location = "playgr"; altLocation = "MP";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "rock-2"; classLeader = "Mr DD"; location = "playgr"; altLocation = "MP";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "rock-3"; classLeader = "Mr DD"; location = "playgr"; altLocation = "MP";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "rock-4"; classLeader = "Mr DD"; location = "playgr"; altLocation = "MP";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		
		act = new Activity(); actName = "pizza-1"; classLeader = "Mr E"; location = "room a"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "pizza-2"; classLeader = "Mr E"; location = "room a"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "pizza-3"; classLeader = "Mr E"; location = "room b"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "pizza-4"; classLeader = "Mr E"; location = "room b"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		
		act = new Activity(); actName = "hockey-1"; classLeader = "Mrs M"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "hockey-2"; classLeader = "Mrs M"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "hockey-3"; classLeader = "Mrs M"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "hockey-4"; classLeader = "Mrs M"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		
		act = new Activity(); actName = "tyedye-1"; classLeader = "Mr X"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "tyedye-2"; classLeader = "Mr X"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "tyedye-3"; classLeader = "Mr X"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
		act = new Activity(); actName = "tyedye-4"; classLeader = "Mr X"; location = "field 1"; altLocation = "Gym";
		act.setActivityCode(actName); act.setActivityLeader(classLeader); act.setLocation(location); act.setAltLocation(altLocation); act.setCapacity(CAPACITY);
		mn.actCapacityMap.put(actName, act);
	...
	List<Student> populateStudentList() {
		...
		Student.setGrade("1");
		Student.getAct().add("bb"); Student.getAct().add("hockey"); Student.getAct().add("rock"); Student.getAct().add("pizza");
		...
		Student.getAct().add("soccer"); Student.getAct().add("flag"); Student.getAct().add("bb"); Student.getAct().add("pizza");
		StudentList.add(Student);
		...
		for (int i=0; i<10; i++) {
			...
			Student.setGrade("3");
			Student.getAct().add("soccer"); Student.getAct().add("bb"); Student.getAct().add("rock"); Student.getAct().add("fb");
			StudentList.add(Student);	
		}
